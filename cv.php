...
<head>
  ...
  <title>Viviana Villamayor - Currículum</title>
  <meta name="description" content="Formación, cursos, masters, etc.">
		...
		<div class="three columns" id="sidebar">
			<nav>
				<ul>
					...
					<li><a class="active" href="cv"  title="Curriculum Vitae">CV</a></li>
